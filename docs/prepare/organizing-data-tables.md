...
This page offers some suggestions on how to organize data within a spreadsheet for inclusion in the BCO-DMO data system. We can curate data submitted in a wide range of file formats, but may ask you to restructure data tables so they are compliant with our system and with FAIR data principles.&#x20;
