...
2\. **Gather** the required information. For NSF-funded projects, we ask that you provide a copy of your [**NSF Data Management Plan**](http://www.bco-dmo.org/nsf-two-page-data-management-plan#DMP\_Template) **** as a PDF. You should also have the following information ready:
...
3\. **Register** your project using our online submission tool ([submit.bco-dmo.org](https://submit.bco-dmo.org/)). Instructions for using the tool for project registration can be found in the "[Registering a Project](registering-a-project-with-submission-tool.md)" section of the Submission Tool Guidance. You can expect to receive a reply within 48 hours (two business days). You can always contact us at [**info@bco-dmo.org**](mailto:info@bco-dmo.org) **** with questions.&#x20;
