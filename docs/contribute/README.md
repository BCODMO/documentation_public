---
description: How can I contribute data to the BCO-DMO data repository?
---
...
2. **Data Files:** The **organization of the data** could vary depending on the data type. There is a distinction between data tables, genetic accessions, and Models & Code. We also have specific guidance for certain research programs or projects, such as GEOTRACES.
