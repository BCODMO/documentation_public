...
When you are ready to submit data to us, create a "Data Submission" using our [Submission Tool](../contribute/submitting-data.md), completing all the required metadata fields and uploading files in the "Files" section.&#x20;
