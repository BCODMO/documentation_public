...
To submit accessions and related data, use our online Submission Tool at [https://submit.bco-dmo.org/](https://submit.bco-dmo.org/) to enter your metadata and upload data files. See the "[Submitting Data](../contribute/submitting-data.md)" page for more information on using the Submission Tool.
