...
Repositories are often categorized into three basic types based on curation effort and disciplinary expertise:

1. General repositories
2. Institutional repositories
3. Domain-specific repository

**General repositories** typically curate data from a wide variety of disciplines to provide discovery and access to heterogeneous types of data.&#x20;

**Institutional repositories** are usually affiliated with a particular academic institution and may reside within the institutional library system. These repositories may be more familiar with the types of research conducted at an institution.
...
![Increased curation activities performed by domain specific repositories lead to F.A.I.R data](<../.gitbook/assets/image (18).png>)
...
BCO-DMO is a **domain-specific repository**, focusing on **biological and chemical oceanography data** resulting from research conducted in coastal, marine, great lakes, and laboratory environments. We work closely with research communities to apply quality controls, create and curate robust discovery- and use-level metadata, and document provenance, thereby increasing data reusability.

## Programs supported by BCO-DMO

BCO-DMO is funded by the US National Science Foundation (NSF) to provide data management services at no additional cost to projects funded by:
...
If your data fit within BCO-DMO's disciplinary scope, it may be possible for us to provide data management services for non-NSF projects. These are typically prioritized after NSF OCE data and are on a fee-for-service basis. Costs are determined after review of the data. Please contact [info@bco-dmo.org](mailto:info@bco-dmo.org) for more information.
