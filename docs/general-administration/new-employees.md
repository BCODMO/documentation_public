...
* Email account set-up:
  * Call IS helpdesk for account + temporary password
  * Change password in internal WHOI site  \) -&gt; Administrative tool -&gt; password changer -&gt; username, password \(15 characters\)
* VPN set-up:
