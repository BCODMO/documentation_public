...
**Tabular data** with biological and chemical oceanographic data from in-situ measurements during cruises or field sampling, sediment samples, lab experiments, etc. make up the bulk of the BCO-DMO data holdings. See the "[Organizing Data Tables](../data-guidance/organizing-data-tables.md)" page for more details on the supported format and organization of tabular data.&#x20;
