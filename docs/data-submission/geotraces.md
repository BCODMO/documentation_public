...
3. To submit the data files and metadata to BCO-DMO, you have two options:
   * Use the online submission tool at [https://submit.bco-dmo.org/](https://submit.bco-dmo.org/) to provide metadata and then upload your data file. Instructions on how to use this tool are on the "[Submitting Data](../submission-tool/submitting-data.md)" page.
